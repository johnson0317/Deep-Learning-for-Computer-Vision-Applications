...
class LogisticRegression(object):
    ...
    def predict(self, X):
        ...
        #############################################################################
        prediction = np.array(list(map(lambda iter : 1 if iter > 0.5 else 0, self.sigmoid(X.dot(W) + b)))).reshape(-1,1)
    ...
    def binary_cross_entropy(self, probs, labels):
        ...
        #############################################################################
        num, dim = probs.shape
        bce = -np.sum(labels * np.log(probs) + (1 - labels) * np.log(1 - probs)) / num
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
    ...
    def loss(self, X, y=None):
        ...
        #############################################################################
        d_pred = probs - y
        grads['W'] = X.T.dot(d_pred) / N
        grads['b'] = np.sum(d_pred) / N
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
