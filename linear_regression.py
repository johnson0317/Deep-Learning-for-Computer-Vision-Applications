...
class LinearRegression(object):
    ...
    def feature_transform(self, X):
        ...
        X_transformed = np.concatenate((X.T, vec[np.newaxis,:]))
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
    ...
    def train_analytic(self, X, y):
        ...
        dot_x = X.T.dot(X)
        dot_y = X.T.dot(y)
        self.params['W'] = np.linalg.pinv(dot_x).dot(dot_y)
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
    ...
    def predict(self, X):
        ...
        #############################################################################
        prediction = None
        param = self.params['W'].T
        X_trans = X.T
        prediction = param.dot(X_trans).T
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
    ...
    def train(self, X, y, X_val=None, y_val=None,learning_rate=1e-3, learning_rate_decay=0.95,
        ...
        for it in range(num_iters):
            ...
            for row in batch_indexes:
                X_batch.append(X[row])
                y_batch.append(y[row])
